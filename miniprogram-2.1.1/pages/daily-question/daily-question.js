Page({
  ...
  onCollect: function() {
    const app = getApp();
    if (!app.globalData.collectedQuestions) {
      app.globalData.collectedQuestions = [];
    }
    
    // Add the current question to the collected questions
    if (!app.globalData.collectedQuestions.includes(this.data.question.title)) {
      app.globalData.collectedQuestions.push(this.data.question.title);
    }
